...
<head>
    ...
    <link href="{{ asset('Assets/template/css/style -1.css') }}" rel="stylesheet" />
    <!-- responsive style -->
...
<body>
            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg custom_nav-container ">
                    <a class="navbar-brand" href="/">
                        <img src="{{ asset('Assets/template/images/logo.png ') }}" alt="">
                        <span>
                            TK Santa Maria
                        </span>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
                            <ul class="navbar-nav  justify-content-end">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ url('../pesdik/alur_pendaftar') }}"> Home</a>
                                </li>
                                <li class="nav-item ">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href=""> Lihat Pendaftar </a>
                                </li>
    ...
    <section class="container-fluid footer_section">
        <p>
            ...
            <a href="https://www.youtube.com/channel/UCHO5t3O1satYKfGnlxGDVsg/playlists?view_as=subscriber">Developed By
                : Kelompok 1</a>
        </p>
    </section>
    <!-- footer section -->
